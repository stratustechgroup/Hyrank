    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <motion.div
              className="relative glass-card-strong w-full max-w-lg p-6 sm:p-8 overflow-hidden my-8"
            ...
            >
              ...
              <AnimatePresence mode="wait">
                ...
                {authLoading ? (
                  ...
                  >
                    <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-hytale-500/20 flex items-center justify-center">
                      <svg
                  ...
                  >
                    <motion.div
                      className="w-20 h-20 mx-auto mb-6 rounded-full bg-adventure-500/20 flex items-center justify-center"
                      initial={{ scale: 0 }}
                      animate={{ scale: 1 }}
                    ...
                    <p className="text-white/60">Your server is pending review.</p>
                  </motion.div>
                ) : (
                  <motion.div
                    key="form"
                  ...
                  >
                    ...
                    <div className="text-center mb-6">
                      <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-adventure-500/10 border border-adventure-500/20 text-adventure-400 text-sm font-medium mb-4">
                        <svg
                          className="w-4 h-4"
                          viewBox="0 0 24 24"
                          fill="none"
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                      {/* Banner Preview */}
                      <div className="aspect-video rounded-xl overflow-hidden bg-void-800 border border-white/10 relative">
                        <AnimatePresence mode="wait">
                          {bannerPreview && !bannerError ? (
                            ...
                            <motion.div
                              key="placeholder"
                              className="w-full h-full flex flex-col items-center justify-center text-white/30"
                              initial={{ opacity: 0 }}
                              animate={{ opacity: 1 }}
                              exit={{ opacity: 0 }}
                            >
                              ...
                              <span className="text-sm">Paste banner URL below</span>
                            </motion.div>
                          )}
                        </AnimatePresence>
                      </div>
                      ...
                      <div>
                        <label className="block text-sm font-medium text-white/70 mb-2">
                          Server Name <span className="text-adventure-400">*</span>
                        </label>
                        <input
                          type="text"
                          value={formData.name}
                      ...
                      <div>
                        <label className="block text-sm font-medium text-white/70 mb-2">
                          Server IP <span className="text-adventure-400">*</span>
                        </label>
                        <input
                          type="text"
                          value={formData.ip}
                      ...
                      <div>
                        <label className="block text-sm font-medium text-white/70 mb-2">
                          Tags{" "}
                          <span className="text-white/40">(select up to 5)</span>
                        </label>
                            ...
                            return (
                              <button
                                ...
                                className={`
                                  ...
                                  ${
                                    isSelected
                                      ? "bg-adventure-500/30 border-adventure-500/50 text-adventure-400"
